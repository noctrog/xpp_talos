...
#ifndef IKFAST_HEADER_COMMON_RIGHT
#define IKFAST_HEADER_COMMON_RIGHT
...
// #endif
    ...
    */
    bool ComputeIk2(const IkReal* eetrans, const IkReal* eerot, const IkReal* pfree, ikfast::IkSolutionListBase<IkReal>& solutions, void* pOpenRAVEManip);
